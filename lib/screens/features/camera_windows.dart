...
class CameraForWindows extends StatefulWidget {
  /// Default Constructor
  const CameraForWindows({super.key});

  @override
  State<CameraForWindows> createState() => _CameraForWindowsState();
}

class _CameraForWindowsState extends State<CameraForWindows> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Plugin Camera app'),
      ),
      body: ListView(
        children: <Widget>[
          Padding(
